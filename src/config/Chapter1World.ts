import type { AreaDefinition, WorldDefinition } from '../domain/World.js';
...
const area = (value: AreaDefinition): AreaDefinition => value;

export const chapter1World: WorldDefinition = {
  areas: {
    bridge: area({
      ...
      interactions:[{id:'bridge.look',rect:{x:510,y:440,w:180,h:120},label:'붕괴된 다리 확인',action:'bridge.lookBack'}],
      decorations:[
    ...
    chaseRoad: area({
      ...
      walls:[...borderWalls(),{x:280,y:0,w:85,h:270},{x:280,y:470,w:85,h:250},{x:860,y:0,w:85,h:470}],
      portals:[],
