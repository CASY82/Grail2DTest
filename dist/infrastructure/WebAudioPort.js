export class WebAudioPort {
    ...
    pulse(kind) {
        ...
        gain.gain.exponentialRampToValueAtTime(kind === 'hollow' ? 0.08 : 0.03, now + 0.01);
        gain.gain.exponentialRampToValueAtTime(0.0001, now + (kind === 'hollow' ? 0.8 : 0.18));
    ...
    ambientTick(kind) {
        ...
        gain.gain.setValueAtTime(0.0001, now);
        gain.gain.linearRampToValueAtTime(kind === 'chase' ? 0.035 : 0.012, now + .1);
